 ...
 * Subtle pulsing heart with gentle animation - elegant, not flashy.
 */
    ...
    <div className={cn('', className)}>
      ...
      <div className="border rounded-lg bg-card overflow-hidden">
        <div className="flex flex-col items-center justify-center py-20 px-8">
          {/* Subtle pulsing heart */}
          <div className="mb-5">
            <svg
              viewBox="0 0 24 24"
              className="w-10 h-10 text-muted-foreground/40 animate-[heartbeat_2s_ease-in-out_infinite]"
              fill="currentColor"
            >
      ...
      {/* Legend placeholder - very subtle */}
